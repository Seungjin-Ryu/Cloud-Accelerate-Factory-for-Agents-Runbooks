...
flowchart TD
    ...
    B["🤖 HROnboardingAutoAgent<br/>──────────────────────────<br/>Built in Microsoft Copilot Studio<br/>Orchestrated by GPT-4o"]

    C["📚 ServiceNow Knowledge Base<br/>──────────────────────────<br/>• Contoso Employee Handbook<br/>• Health & Wellness Benefits Guide<br/>via Microsoft Copilot Connector"]

    D1["💬 Chat Response<br/>──────────────────────────<br/>M365 Copilot / Microsoft Teams<br/>with source citations"]

    D2["📧 Autonomous Email Reply<br/>──────────────────────────<br/>via Office 365 Outlook<br/>SendEmail Tool"]
...
- HR policy and onboarding Q&A (employee handbook, benefits, code of conduct)
...
- Out-of-scope question handling (graceful escalation to HR contact)
...
| Architecture Diagram | [2-Architecture.md](./2-Architecture.md) |
| Sample Prompts | [4-Sample-Prompts.md](./4-Sample-Prompts.md) |
| Agent Instructions Template | [agent-instructions.md](./Resources/agent-instructions.md) |
| CDX Demo Tenant Setup | [https://aka.ms/copilotdemotenant](https://aka.ms/copilotdemotenant) |
